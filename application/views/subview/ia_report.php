    ...
    <tbody>
        ...
        foreach ($report_info as $info) {
            ...
            <tr>
                ...
                <?php
                foreach ($ia_report[$i] as $attendance) {
...
<table class="table table-hover table-bordered pull-left" style="width: 50%;">
    <thead>
        <tr>
            <th>Sno</th>
            <th>Subject Code</th>
...
<table class="table table-hover table-bordered pull-right" style="width: 30%;">
    <thead>
        <tr>
            <th colspan="2" class="text-center">Internal Assessment</th>
        </tr>
        <tr>
            <td>Max Marks</td>
            <td>20</td>
